...
public class YahooFinanceScraper implements Scraper {
    ...
    public ScrapedResult scrap(Company company) {
        ...
        try {
            ...
            Elements parsingDivs = document.getElementsByAttributeValue("data-test", "historical-prices"); // html 문서에서 태그, id, 클래스 값 찾아서 사용
            Element tableEle = parsingDivs.get(0); // 테이블 전체

            Element tbody = tableEle.children().get(1); // head는 0 foot은 2
